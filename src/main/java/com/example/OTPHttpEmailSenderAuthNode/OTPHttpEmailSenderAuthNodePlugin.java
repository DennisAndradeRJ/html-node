 ...
 * @since AM 5.5.0
 */
public class OTPHttpEmailSenderAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(OTPHttpEmailSenderAuthNodePlugin.currentVersion, 
				Collections.singletonList(OTPHttpEmailSenderAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return OTPHttpEmailSenderAuthNodePlugin.currentVersion;
	}
}
